...
import { signInWithDiscord, getMurklIdentifier, useSession, signOut } from '../lib/auth-client';
  ...
  return (
    <div className="oauth-login">
      ...
      <div className="oauth-buttons" role="group" aria-label="Sign in options">
        ...
        <motion.p 
          className="oauth-coming-soon"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.3 }}
        >
          Twitter & Google coming soon
        </motion.p>
      </div>
